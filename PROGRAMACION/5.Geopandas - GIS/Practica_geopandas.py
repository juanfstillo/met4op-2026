...
# Ruta base del proyecto (3 niveles arriba desde este script)
BASE = Path(__file__).resolve().parents[2] / 'dataset'

#%% Leo y reviso los datos electorales de las legislativas 2025
mesas = pd.read_csv(BASE / 'elecciones_caba_2025/mesas25.csv')
#%%
print(mesas.head())
print(mesas.info())
...
circuitos_gdf = gpd.read_file(BASE / 'circuitos-electorales/circuitos-electorales.shp')
# %%
...
barrios_gdf = gpd.read_file(BASE / 'barrios_caba/caba_barrios.geojson')
...
precios_m2 = {
    ...
    'Parque Chacabuco': 2365,
    'Parque Chas': 2527,
    'Parque Patricios': 1796,
    'Puerto Madero': 5865,
    'Recoleta': 2811,
    'Retiro': 2425,
    'Saavedra': 2726,
    ...
    'San Nicolás': 2043,
    'San Telmo': 2336,
    'Vélez Sarsfield': 1851,
    'Versalles': None,
    'Villa Crespo': 2573,
    'Villa del Parque': 2399,
    'Villa Devoto': 2501,
    'Villa Gral. Mitre': 2245,
    'Villa Lugano': None,
    'Villa Luro': 2149,
    'Villa Ortúzar': 2570,
    'Villa Pueyrredón': 2389,
    'Villa Real': None,
    'Villa Riachuelo': None,
    'Villa Santa Rita': 2162,
    'Villa Soldati': None,
    'Villa Urquiza': 2728
}
# %%
